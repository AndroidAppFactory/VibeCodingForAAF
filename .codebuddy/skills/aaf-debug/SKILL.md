...
**AI 必须使用 `todo_write` 工具展示调试进度**，让用户清晰了解当前状态。
...
```json
[
  {"id": "1", "status": "in_progress", "content": "识别模块并收集问题"},
  {"id": "2", "status": "pending", "content": "理解代码逻辑"},
  {"id": "3", "status": "pending", "content": "准备调试日志"},
  {"id": "4", "status": "pending", "content": "等待用户运行程序"},
  {"id": "5", "status": "pending", "content": "分析 ADB 日志"},
  {"id": "6", "status": "pending", "content": "定位问题并提供修复"},
  {"id": "7", "status": "pending", "content": "清理调试日志"}
]
```
...
- 阶段 4（等待运行）保持 `in_progress` 直到用户说"结束"
...
todo_write(merge=true, todos=[
  {"id": "1", "status": "completed", "content": "识别模块并收集问题"},
  {"id": "2", "status": "in_progress", "content": "理解代码逻辑"}
])
```
